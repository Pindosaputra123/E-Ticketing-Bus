...
<html lang="en">
  <head>
    ...
    <title>blueBus - Pengaturan</title>
  ...
  ?>
    ...
    <div data-aos="fade-zoom-in">
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">Level Akun</h6>
        <div class="progress">
  <div class="progress-bar bg-warning" role="progressbar" style="width: <?=$total?>%" aria-valuenow="<?=$total?>" aria-valuemin="0" aria-valuemax="100"></div>
    ...
    <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">Anggota</strong>
              <a href="#" data-toggle="modal" data-target="#viewTierBenefits">Lihat Keuntungan Level Akun</a>
            </div>
            <span class="d-block">Dapatkan <?=1000-$total?> poin untuk naik ke perak.</span>
          </div>
      </div>
    ...
    <div data-aos="fade-right">
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">Akun</h6>
        ...
        <img src="https://raw.githubusercontent.com/google/material-design-icons/master/communication/2x_web/ic_phone_black_48dp.png" alt="" class="mr-2 rounded" style="width:10%; max-width:25px;">
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">No Handphone</strong>
        ...
        <img src="https://raw.githubusercontent.com/google/material-design-icons/master/action/2x_web/ic_lock_black_48dp.png" alt="" class="mr-2 rounded" style="width:10%; max-width:25px;">
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              ...
              <a href="#" data-toggle="modal" data-target="#editPassword">Atur ulang password</a>
            </div>
            <span class="d-block">Terakhir diganti: <?=$myStartDate?></span>
          </div>
        </div>
      </div>
      </div>
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h6 class="border-bottom border-gray pb-2 mb-0">Profil</h6>
        <div class="media text-muted pt-3">
        ...
        <img src="https://raw.githubusercontent.com/google/material-design-icons/master/maps/2x_web/ic_my_location_black_48dp.png" alt="" class="mr-2 rounded" style="width:10%; max-width:25px;">
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">Negara</strong>
