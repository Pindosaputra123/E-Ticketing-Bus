...
<html lang="en">
  <head>
    ...
    <title>blueBus - Kelola Pemesanan</title>
  ...
  <header>
    ...
    <div data-aos="zoom-out">
      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h5 class="border-bottom border-gray pb-2 mb-0">Pemesanan yang akan datang</h5>
...
<div data-aos="fade-right" data-aos-duration="2000">
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h5 class="border-bottom border-gray pb-2 mb-0">Pemesanan sebelumnya</h5>
        <table class="table table-hover">
  <thead>
    <tr>
      <th scope="col">Tanggal</th>
