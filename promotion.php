           ...
           <div class="form-row  col-md-12">
            <div class="form-group col-md-4 text-left">
             <!-- Select Bus From (Departure)-->
              <label for="desctiption"  style="color:white;"><h5>Promosi dari Pindo Transport</h5></label>
            </div>
          </div>
        </form>
       </div>
    ...
    <!-- Bus Result Table -->
      <div data-aos="fade-left" data-aos-duration="2000">
        <div class="my-3 p-3 bg-white rounded box-shadow">
           <h5 class="border-bottom border-gray pb-2 mb-0">Ini promosi Anda. Pesan tiket hari ini dan manfaatkan! </h5>
